...
2. New type of wood and tree to collect/see!
3. Two new ores to find in the mines!
4. Variety of new animals to encounter!
5. New trader to stumble apon!
6. Two new structures to find!
7. New biome to go explore in!
8. Much more!
...
2. Beta APIs
3. Experimental Voxel Shapes Feature

 # Multiplayer Compatiblity:
 Pretty straight forward from here
 1. Shared packs: You will have to turn it on so that way your friends will have to download the pack!
 2. Who can join: This is optional obviously but you can set to invite only, friends only, friends of friends, or turn it off
